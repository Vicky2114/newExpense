...
//     //total turnover
//     //reduce function give accumulator
...
const Analytics = ({ allTransaction }) => {
  ...
  return (
    <>
      ...
      <div className="category-wise-income">
        <h4 className="heading2">CategoryWise Income</h4>
        {categories.map((category) => {
      ...
      <div className="category-wise-expense">
        <h4 className="heading2">CategoryWise Expense</h4>
        {categories.map((category) => {
          const amount = allTransaction
